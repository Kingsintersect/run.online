...
import type { CompleteStageConfig } from "@/types/admissionConfig"
import type { StepSectionProps } from "../types/admission"

interface AdmissionCompleteSectionProps extends StepSectionProps {
  /** The COMPLETE stage's settings — message and button. */
  config?: CompleteStageConfig
  /** Labels of the stages the applicant completed, for the summary. */
...
const DEFAULT_CHECKLIST = [
  ...
  "Admission Offered & Accepted",
  "Acceptance Fee Paid",
  "Tuition Fee Paid",
]

export function AdmissionCompleteSection({
  student,
  config,
  completedStageLabels,
}: AdmissionCompleteSectionProps) {
  ...
  const checklist = completedStageLabels?.length
    ? completedStageLabels
    : DEFAULT_CHECKLIST
  const ctaLabel = config ? config.ctaLabel : "View My Courses"
  const ctaHref = config ? config.ctaHref : "/student/courses"
