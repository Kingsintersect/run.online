...
APP_DIR="${1:-/home/qverselearning/run.online.qverselearning.org}"
APP_NAME="${2:-run.online.qverselearning.org}"
APP_PORT="${3:-3031}"
DOMAIN="${4:-run.online.qverselearning.org}"
LE_EMAIL="${5:-support@qverselearning.com}"
BACKEND_URL="${6:-https://run.api.qverselearning.org/api/v1/}"   # optional — trailing slash required
